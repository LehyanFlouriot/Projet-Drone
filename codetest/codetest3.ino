...
const int puissanceMini = 70;
const int puissanceMaxi = 90;
  ...
  // If programming failed, don't try to do anything
    ...
    if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
        ...
        */    
        ...
        if (puissanceA < puissanceMini){puissanceA = puissanceMini;}
        if (puissanceB < puissanceMini){puissanceB = puissanceMini;}
        if (puissanceC < puissanceMini){puissanceC = puissanceMini;}
        if (puissanceD < puissanceMini){puissanceD = puissanceMini;}

        if (puissanceA > puissanceMaxi + 10){puissanceA = puissanceMaxi + 10;}
        if (puissanceB > puissanceMaxi + 10){puissanceB = puissanceMaxi + 10;}
        if (puissanceC > puissanceMaxi + 10){puissanceC = puissanceMaxi + 10;}
        if (puissanceD > puissanceMaxi + 10){puissanceD = puissanceMaxi + 10;}
